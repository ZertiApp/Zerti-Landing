		...
		<div id="privacy">
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Zerti, No address.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Zerti, accessible from{" "}
						<a href="https://zerti.com.ar/" rel="external nofollow noopener" target="_blank">
							https://zerti.com.ar/
						</a>
					</p>
				</li>
			...
			<ul>
				...
				<li>
					...
					interact in the public areas with other users, such information may be viewed by all users
			...
			<ul>
				<li>By email: email@zerti.com.ar</li>
			</ul>
		</div>
	);
}
